...
function TabList_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(2, TabList_Conditional_0_Conditional_2_Template, 1, 1, "ng-container")(3, TabList_Conditional_0_Conditional_3_Template, 1, 0, ":svg:svg", 10);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext();
...
function TabList_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(2, TabList_Conditional_8_Conditional_2_Template, 1, 1, "ng-container")(3, TabList_Conditional_8_Conditional_3_Template, 1, 0, ":svg:svg", 12);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext();
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function TabList_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵprojectionDef();
        ɵɵtemplate(0, TabList_Conditional_0_Template, 4, 7, "button", 5);
        ...
        ɵɵelementEnd()();
        ɵɵtemplate(8, TabList_Conditional_8_Template, 4, 7, "button", 5);
      }
      if (rf & 2) {
...
var TabPanel = class _TabPanel extends BaseComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function TabPanel_HostBindings(rf, ctx) {
      if (rf & 2) {
        ɵɵhostProperty("hidden", !ctx.active());
    ...
    template: function TabPanel_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵprojectionDef();
        ɵɵtemplate(0, TabPanel_ng_template_0_Template, 1, 0, "ng-template", null, 0, ɵɵtemplateRefExtractor)(2, TabPanel_Conditional_2_Template, 1, 1, "ng-container");
      }
      if (rf & 2) {
        ɵɵadvance(2);
