...
var ue = (e = {}, t, r, s3) => {
  if (t) {
    let {
      ...
      prefix: n,
      transform: l2
    } = (e == null ? void 0 : e.options) || a2 || {}, o = G(t, k) ? t : `{${t}}`;
...
var b = {
  ...
  getCommon({
    ...
    if (s2(a2) && n.transform !== "strict") {
      let {
        ...
        colorScheme: K
      } = f, A2 = v(f, ["colorScheme"]), x = re2 || {}, {
        colorScheme: X
      } = x, G2 = v(x, ["colorScheme"]), p = K || {}, {
        dark: U
      } = p, B = v(p, ["dark"]), y = X || {}, {
        dark: I
      } = y, H2 = v(y, ["dark"]), W = s2(L) ? this._toVariables({
        primitive: L
      }, n) : {}, q2 = s2(A2) ? this._toVariables({
        semantic: A2
      }, n) : {}, Z = s2(B) ? this._toVariables({
        light: B
      }, n) : {}, pe = s2(U) ? this._toVariables({
        dark: U
      }, n) : {}, fe = s2(G2) ? this._toVariables({
        semantic: G2
      }, n) : {}, ye = s2(H2) ? this._toVariables({
        light: H2
      ...
      d = `${et}${tt}`, u = [.../* @__PURE__ */ new Set([...We, ...Ze, ...Je])], g = m(a2.css, {
        dt: E
      });
    }
    return {
  ...
  getPreset({
    ...
    if (s2(t) && r.transform !== "strict") {
      let y = e.replace("-directive", ""), m2 = t, {
        ...
        dark: te
      } = g, re2 = v(g, ["dark"]), K = s2(O) ? this._toVariables({
        [y]: h(h({}, O), z2)
      }, r) : {}, A2 = s2(L) ? this._toVariables({
        [y]: h(h({}, L), re2)
      }, r) : {}, X = s2(V) ? this._toVariables({
        [y]: h(h({}, V), te)
      }, r) : {}, [G2, U] = [(f = K.declarations) != null ? f : "", K.tokens || []], [B, I] = [(x = A2.declarations) != null ? x : "", A2.tokens || []], [H2, W] = [(p = X.declarations) != null ? p : "", X.tokens || []], q2 = this.transformCSS(y, `${G2}${B}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y, H2, "dark", "variable", r, i2, a2, n);
      l2 = `${q2}${Z}`, o = [.../* @__PURE__ */ new Set([...U, ...I, ...W])], c = m(j, {
        dt: E
      });
    }
    return {
  ...
  getPresetC({
    ...
    let {
      preset: a2,
      options: n
    } = t, l2 = (o = a2 == null ? void 0 : a2.components) == null ? void 0 : o[e];
  ...
  getCommonStyleSheet({
    ...
    let n = this.getCommon({
      ...
      set: i2,
      defaults: a2
    }), l2 = Object.entries(s3).reduce((o, [c, m2]) => o.push(`${c}="${m2}"`) && o, []).join(" ");
  ...
  getStyleSheet({
    ...
    let n = {
      ...
      set: i2,
      defaults: a2
    }, l2 = (c = e.includes("-directive") ? this.getPresetD(n) : this.getPresetC(n)) == null ? void 0 : c.css, o = Object.entries(s3).reduce((m2, [d, u]) => m2.push(`${d}="${u}"`) && m2, []).join(" ");
    ...
    if (s2(t)) {
      ...
      if (s3 !== "style") {
        ...
        t = r === "dark" ? c.reduce((m2, {
          type: d,
          selector: u
        }) => (s2(u) && (m2 += u.includes("[CSS]") ? u.replace("[CSS]", t) : this.getSelectorRule(u, l2, d, t)), m2), "") : C2(l2 != null ? l2 : ":root,:host", t);
      }
      if (o) {
        let c = {
          name: "primeui",
        ...
        i(o) && (c.name = m(o.name, {
          name: e,
          type: s3
        })), s2(c.name) && (t = C2(`@layer ${c.name}`, t), a2 == null || a2.layerNames(c.name));
      }
      return t;
    }
    return "";
...
var S = {
  ...
  transformCSS(e = "", t, r = "style", s3) {
    return b.transformCSS(e, t, s3, r, this.options, {
      layerNames: this.setLayerNames.bind(this)
    }, this.defaults);
  },
...
//# sourceMappingURL=chunk-R722F7PF.js.map
